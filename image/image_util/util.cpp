...
// */
//image_ptr readImage(char *file, int type) 
//{ 
//    int  sz[2];
//    FILE *fp;
//    image_ptr  I;
...
// */
//int saveImage(image_ptr I, char *file, int type) 
//{ 
//    int  sz[2];
//    FILE *fp;
//    
...
// * Return image structure pointer.
// */
//image_ptr allocImage(int w, int h, int type) 
//{ 
//    //uchar *memptr;
//    image_ptr  I;
//    
//    /* allocate memory for image data structure */
//    I = (image_ptr) malloc(sizeof(imageS));
//    if(I == NULL) {
